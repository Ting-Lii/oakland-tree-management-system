//// ting li
// THIS FILE WILL BE COMPELTEDLY DETELED LATER.
...
//                System.out.println("Enter 'tp' to update tree planting and immediately assign a volunteer.");
//                System.out.println("⚡ Note: You must complete a site visit (sv) before updating planting (tp)!");
//                System.out.println("Enter 'q' to logout.");
//
...
//                } else if (adminCmd.equals("tp")) {
//                    adminDAO.canUpdateTreePlantingAndAssignVolunteer(scanner, adminID);
